...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/adminverified").permitAll()
                .antMatchers("/adminDeclined").permitAll()
                .antMatchers("/adminPostMessage").permitAll()
                ...
                .antMatchers("/topic/zeed").permitAll()
                .antMatchers("/fetchAdminNotificationPage").permitAll()
                ...
                .antMatchers("/fetchNotificationPage").permitAll()
                .antMatchers("/modalVerDecDet").permitAll()
                .antMatchers("/user/postMessage").permitAll()
